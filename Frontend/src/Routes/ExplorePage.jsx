...
const EmptyWrap = styled.div`
    padding: 120px 40px;
    text-align: center;
    p { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.5rem; font-weight: 500; font-style: normal; color: #bbb; margin: 0 0 24px; }
...
const WorkCardNoImg = styled.div`
    ...
    display: flex; align-items: center; justify-content: center;
    font-family: 'Cormorant Garamond', Georgia, serif;
    font-size: 3rem; font-weight: 500; font-style: normal;
...
const ModalName = styled.p`
    font-family: 'Cormorant Garamond', Georgia, serif;
    font-size: 1.4rem; font-weight: 500; font-style: normal;
